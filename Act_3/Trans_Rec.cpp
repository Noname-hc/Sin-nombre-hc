...
namespace Tp2_Act_1 {
    void Trans_Rec::SetCadena(const std::string& nuevaCadena) {
        cadena = nuevaCadena;
    }
    ...
    void Trans_Rec::T_R_Init(int Brate, uint8_t Stop_bits, std::string Port) {
    ...
    void Trans_Rec::Recepcion(char* Buffer, int Buff_Len, int timeout_ms) {
        if (fd < 0) {
